...
int main(int argc, char *argv[]) {
    ...
    QWidget *videoPlayerWindow = new QWidget();
    QVBoxLayout *videoLayout = new QVBoxLayout(videoPlayerWindow);

    // The widget that will show the video
    QVideoWidget *videoWidget = new QVideoWidget(videoPlayerWindow);
    ...
    videoPlayerWindow->setLayout(videoLayout);
    ...
    mainLayout->addWidget(videoPlayerWindow);
